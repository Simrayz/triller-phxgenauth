defmodule TrillerWeb.UserAuthTest do
  use TrillerWeb.ConnCase, async: true

  alias Triller.Accounts
  alias TrillerWeb.UserAuth
  import Triller.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, TrillerWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      TrillerWeb.Endpoint.subscribe(live_socket_id)
